  ...
  return (
    <div>
      ...
      {exp.projects.map((project) => (
        <Typography key={project.title} component="div" className={classes.project}>
          ...
          {project.list &&
            project.list.map((i) => (
              <Box key={i} fontSize={15} fontWeight="fontWeightLight" style={{ marginLeft: '1em' }}>
                {i}
              </Box>
            ))}
          <Box fontSize={15} fontWeight="fontWeightLight" style={{ marginLeft: '2em', color: '#777777' }}>
