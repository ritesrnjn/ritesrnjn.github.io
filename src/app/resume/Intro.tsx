...
export default function Intro({ details }) {
  const resumeUrl: string =  `${process.env.PUBLIC_URL}/resume.pdf`

  return (
      <div className='grid grid-cols-1 sm:grid-cols-12 mb-12'>
        <div className="col-span-1 sm:col-span-6">
          <h1 className='font-light text-4xl text-green-600'>
            {details.name}
          </h1>
        ...
        <div className="col-span-1 sm:col-span-6 flex flex-col sm:items-end font-light">
          ...
          <a href={resumeUrl} className='print:hidden flex sm:justify-end' target="_blank">
